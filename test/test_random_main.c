...
void test_boundary_cases(void) {
	...
	//percent cases
	std_ret = printf("percent case1: |%%%%|\n");
	ft_ret = ft_printf("percent case1: |%%%%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case2: |%5%|\n");
	ft_ret = ft_printf("percent case2: |%5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case3: |%-5%|\n");
	ft_ret = ft_printf("percent case3: |%-5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case4: |%+5%|\n");
	ft_ret = ft_printf("percent case4: |%+5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case5: |%05%|\n");
	ft_ret = ft_printf("percent case5: |%05%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case6: |%0 5%|\n");
	ft_ret = ft_printf("percent case6: |%0 5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case7: |%.5%|\n");
	ft_ret = ft_printf("percent case7: |%.5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case8: |%.%|\n");
	ft_ret = ft_printf("percent case8: |%.%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case9: |%8.5%|\n");
	ft_ret = ft_printf("percent case9: |%8.5%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case10: |%5.8%|\n");
	ft_ret = ft_printf("percent case10: |%5.8%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case11: |%#3%|\n");
	ft_ret = ft_printf("percent case11: |%#3%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
	...
	std_ret = printf("percent case12: |%#6.%|\n");
	ft_ret = ft_printf("percent case12: |%#6.%|\n");
	if (std_ret != ft_ret) {
		printf("\033[1;31m");
		printf("Return value: printf = %d, ft_printf = %d\n", std_ret, ft_ret);
		printf("\033[0m");
